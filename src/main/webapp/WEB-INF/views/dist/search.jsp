		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid" style="margin-top: 250px;">
					<h2 class="mt-4" style="color: #f8f9fa; text-align: center; font-size: xxx-large; font-weight: bolder;">어떤 집을 찾고 계세요?</h2>
						...
						<form class="ml-auto mr-0 mr-md-3 my-2 my-md-0" id="searchform" method="get" action="${root}/map/searchResult">
							<div class="form-row">
								...
								<div class="col-12 col-md-6 mb-2 mb-md-0">
									<input type="text" name="word" class="form-control form-control-lg" placeholder="">
								</div>
